...
BEGIN transaction;
   SELECT citymap.fill_ride_on_day(1,11);
   SELECT citymap.fill_ride_on_day(2,13);
   SELECT citymap.fill_ride_on_day(3,27);
   SELECT citymap.fill_ride_on_day(4,28);
   SELECT citymap.fill_ride_on_day(5,21);
   SELECT citymap.fill_ride_on_day(6,19);
COMMIT transaction;
